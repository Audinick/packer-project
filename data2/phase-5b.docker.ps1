...
Write-Output "Phase 5b [INFO] - Install Dockermsftprovider successful"
try {
...
Write-Output "Phase 5b [SKIPPED] - Docker step intentionally skipped"
exit 0
